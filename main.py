...
from visualizer import MotionViewerWindow, BVHOpenGLWidget

os.environ["PYSIDE_DESIGNER_PLUGINS"] = os.path.dirname(os.path.realpath(__file__))+"/visualizer"
...
def main():
    ...
    main_window: MotionViewerWindow = loader.load(os.path.dirname(os.path.realpath(__file__)) + '/visualizer/main_window.ui')
